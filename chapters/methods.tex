...
merge\_parallel(line\_segments)\;
 ...
 \caption{Lidar data segmentation using split and merge algorithm. \textbf{C} is clustering distance and \textbf{S} is splitting distance.}
