\chapter{Methods}
In this chapter of the thesis are described methods that can be applied to the detection of the bricks. Multiple methods are presented. Each method is supposed to tackle different a part of detection process. Only a brief description is provided, and all methods are presented in a general form. 
