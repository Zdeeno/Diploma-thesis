...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{fig/detection_range.png}
...
\begin{algorithm}[]
	...
	\While{not done}{
		...
		\If{has\_all\_objects}{
			done = True\;	
		}
	}
	\If{not has\_all\_objects or waypoints.empty()}{
